...
public class FinalDecoding {
    public static void main(String[] args) {
        ...
        WordReplacementCipher abc = new WordReplacementCipher("world", "neighborhood");
        WordReplacementCipher def = new WordReplacementCipher("enigma device", "grill");
        WordReplacementCipher ghi = new WordReplacementCipher("fort knox", "my garage");
        WordReplacementCipher jkl = new WordReplacementCipher("omni-matrix", "propane-tank");
        WordReplacementCipher mno = new WordReplacementCipher("fort knox", "my garage");
        CaesarCipher ib = new CaesarCipher(5);
        EvenOddCipher bi = new EvenOddCipher();
        ...
        BaseCipher[] cipherChain = {ib, bi, abc, def, ghi, jkl, mno};
